...
<li class="breadcrumb-item text-muted">
<a href="<?=base_url('Projects/project_listing')?>" class="text-muted text-hover-primary">Projects List</a>
</li>
<li class="breadcrumb-item">
<span class="bullet bg-gray-200 w-5px h-2px"></span>
</li>
...
?>
<option value="<?=$w_type->id?>" <?= ($w_type->id == $query->work_type) ? 'selected' : '' ?>><?=$w_type->category_name ?></option>
<?php } }?>
</select>    
<div class="fv-plugins-message-container invalid-feedback"></div>
</div>
...
<div class="row mb-6">
<label class="col-md-2 col-form-label  required fw-bold fs-6 mb-5">Work Name</label>
<div class="col-md-4 mb-5">
<div class="row">
<div class="fv-row fv-plugins-icon-container">
<input type="text" name="work_name" class="form-control  mb-3 mb-lg-0" placeholder="Work name" value="<?=$query->work_name?>" required>
<div class="fv-plugins-message-container invalid-feedback"></div>
</div>
</div>
</div>
<label class="col-md-2 col-form-label  required fw-bold fs-6 mb-5">Supplier Name</label>
<div class="col-md-4 mb-5">
<div class="row">
<div class="fv-row fv-plugins-icon-container">
<input type="text" name="supplier_name" class="form-control  mb-3 mb-lg-0" placeholder="Supplier Name" value="<?=$query->supplier_name?>" required>
<div class="fv-plugins-message-container invalid-feedback"></div>
</div>
</div>
</div>
...
<div class="row mb-6">
<label class="col-md-2 col-form-label  required fw-bold fs-6 mb-5">Work Details</label>
<div class="col-md-4 mb-5">
<div class="row">
<div class="fv-row fv-plugins-icon-container">
<textarea class="form-control" id="work_details" rows="5" name="work_details" placeholder="Work Details" required><?=$query->work_details?></textarea>
<div class="fv-plugins-message-container invalid-feedback"></div>
</div>
</div>
</div>
<label class="col-md-2 col-form-label  required fw-bold fs-6 mb-5">Color/Code</label>
<div class="col-md-4 mb-5">
<div class="row">
<div class="fv-row fv-plugins-icon-container">
<input type="text" name="color_code" class="form-control  mb-3 mb-lg-0" placeholder="Color Code" value="<?=$query->color_code?>" required>
<div class="fv-plugins-message-container invalid-feedback"></div>
</div>
</div>
</div>
...
<div class="row">
<div class="fv-row fv-plugins-icon-container">
<textarea class="form-control" id="notes" rows="5" name="notes" placeholder="Notes" required><?=$query->notes?></textarea>
<div class="fv-plugins-message-container invalid-feedback"></div>
</div>
</div>
</div>
<label class="col-md-2 col-form-label  required fw-bold fs-6 mb-5">Upload Image</label>
<div class="col-md-4 mb-5">
<div class="row">
<div class="fv-row fv-plugins-icon-container">
<input type="file" class="form-control" name="files_1[]" multiple />
<span style="color:red">You can upload Multiple Documents</span>
<?php
...
<div class="row">
<div class="fv-row fv-plugins-icon-container">
<input type="text" name="client_name" class="form-control  mb-3 mb-lg-0" placeholder="Client Name" value="<?=$query->client_name?>" required>
<div class="fv-plugins-message-container invalid-feedback"></div>
</div>
</div>
</div>
<label class="col-md-2 col-form-label  required fw-bold fs-6 mb-5">Project Manager</label>
<div class="col-md-4 mb-5">
<div class="row">
<div class="fv-row fv-plugins-icon-container">
<input type="text" name="project_manager" class="form-control  mb-3 mb-lg-0" placeholder="Project Manager" value="<?=$query->project_manager?>" required>
<div class="fv-plugins-message-container invalid-feedback"></div>
</div>
</div>
</div>
