...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div class="d-flex align-items-center py-1">
            <div class="">
                <a href="<?= base_url('Projects/saveProjectAssign') ?>" class="btn btn-primary" >
    ...
    <div id="kt_content_container" class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_listing_table" width="100%">
                    <!--begin::Table head-->
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        if (!empty($datas)) {
                            foreach ($datas as $k => $rows) {
                                ...
                                $edit_link = base_url('Projects/saveProjectAssign/' . $id);
                                $delete_link = base_url('Projects/project_remove/' . $id);
                                $status_link = base_url('Projects/projectAssignStatusChange/' . $id);
                                ...
                                <tr id="tr_<?= $rows->id ?>">							
                                    ...
                                    <td>
                                        <a href="<?=$edit_link?>" class="text-gray-600 text-hover-primary mb-1"><?= $rows->pname ?></a>
                                    </td>
                                    <td><?= $rows->cname ?></td>
                                    <td><?= ucfirst($rows->name) ?></td>
                                    <td data-filter="">
                                        <a href="<?= $status_link ?>" class="badge badge-light-<?= ($rows->status == '1') ? 'success' : 'danger' ?>"><?= ($rows->status == '1') ? 'Completed' : 'Not Completed' ?></a>
                                    </td>
                                    <td class="text-end">								
                                         <a href="<?=$edit_link?>">
...
$this->load->view('admin/_project_assign_js', $this->data);
?>
