...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div class="d-flex align-items-center py-1">
            <div class="">
                <a href="<?= base_url('Projects/saveProjectDetails') ?>" class="btn btn-primary" >
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        if (!empty($datas)) {
                            foreach ($datas as $k => $rows) {
                                ...
                                $edit_link = base_url('Projects/saveProjectDetails/' . $id);
                                $delete_link = base_url('Projects/project_remove/' . $id);
                                $status_link = base_url('Projects/projectDetailsStatusChange/' . $id);
