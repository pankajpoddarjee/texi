...
<li class="breadcrumb-item text-muted">
<a href="<?=base_url('Users/listingEmployee')?>" class="text-muted text-hover-primary">Employee List</a>
</li>
<li class="breadcrumb-item">
<span class="bullet bg-gray-200 w-5px h-2px"></span>
</li>
...
<div class="">
<a href="<?=base_url('Users/listingEmployee')?>" class="btn btn-white btn-active-light-danger me-2">Back</a>
...
<h3 class="fw-bolder m-0">Employee (Personal) Details</h3>
</div>
<!--end::Card title-->
...
<div class="row mb-12">
<label class="col-md-3 col-form-label required fw-bold fs-6">Employee Login ID</label>
<div class="col-md-6">
<input type="text" class="form-control" id="login_id" name="login_id" value="<?=!empty($query->user_login_id)?$query->user_login_id:generateUserLoginId('EM')?>" placeholder="Customer Login ID" readonly>
</div>
<!--<label class="col-md-2 col-form-label fw-bold fs-6 text-lg-end text-md-end required">Password</label>
<div class="col-md-4">
...
<div class="row mb-6">
<label class="col-md-2 col-form-label required fw-bold fs-6">Employee Code</label>
<div class="col-md-10">
<div class="row">
<div class="fv-row fv-plugins-icon-container">
<input type="text" name="staff_code" class="form-control " placeholder="Employee Code" value="<?=$query->staff_code?>" required>
<div class="fv-plugins-message-container invalid-feedback"></div>
</div>
</div>
</div>
...
<div class="row mb-6">
<label class="col-md-2 col-form-label required fw-bold fs-6 mb-5">Employee Code</label>
...
<label class="col-md-2 col-form-label  fw-bold fs-6 mb-5 text-end required">Position/Work</label>
<div class="col-md-4 mb-5">
<div class="row">
<div class="fv-row fv-plugins-icon-container">
<select name="position_work" id="position_work" aria-label="Select a Position/Work"  data-placeholder="Select a Position/Work" class="form-select" required>
    <option value="">Please Select</option>
    <option value="carpenter" <?=($query->position_work == 'carpenter') ? 'selected' : ''; ?>>Carpenter</option>
    <option value="concrete" <?= ($query->position_work == 'concrete') ? 'selected' : ''; ?>>Concrete</option>
    <option value="marble_flooring" <?= ($query->position_work == 'marble_flooring') ? 'selected' : ''; ?>>Marble Flooring</option>
    <option value="plumber" <?= ($query->position_work == 'plumber') ? 'selected' : ''; ?>>Plumber</option>
    <option value="electrical" <?= ($query->position_work == 'electrical') ? 'selected' : ''; ?>>Electrical</option>
</select>
<div class="fv-plugins-message-container invalid-feedback"></div>
</div>
</div>
</div>
<label class="col-md-2 col-form-label  fw-bold fs-6 mb-5">Pincode</label>
<div class="col-md-4 mb-5">
<div class="row">
<div class="fv-row fv-plugins-icon-container">
<input type="text" name="pincode" class="form-control " placeholder="pincode" value="<?=$query->pincode?>">
<div class="fv-plugins-message-container invalid-feedback"></div>
</div>
</div>
</div>
<label class="col-md-2 col-form-label  fw-bold fs-6 mb-5 text-end">Country</label>
<div class="col-md-4 mb-5">
<div class="row">
<div class="fv-row fv-plugins-icon-container">
<select name="country_id" aria-label="Select a Country"  data-placeholder="Select a Country.." class="form-select " onchange="getStateList(this.value)">
