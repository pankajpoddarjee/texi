        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_listing_table">
                ...
                if(!empty($datas)){
                        foreach($datas as $k=> $rows)
                        {
                                ...
                                $edit_link = base_url('ProjectsCategory/save/'.$id);
                                $delete_link = base_url('ProjectsCategory/remove/'.$id);
                                $status_link = base_url('ProjectsCategory/statusChange/'.$id);
                                $query = $this->StaffCategory_model->getStaffCategoryDetails($rows->id);
                                $edit['query']=$query;
