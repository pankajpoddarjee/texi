...
<li class="breadcrumb-item text-muted">
<a href="<?=base_url('Users/listingStaff')?>" class="text-muted text-hover-primary">Staff List</a>
</li>
<li class="breadcrumb-item">
<span class="bullet bg-gray-200 w-5px h-2px"></span>
</li>
...
<div class="">
<a href="<?=base_url('Users/listingStaff')?>" class="btn btn-white btn-active-light-danger me-2">Back</a>
...
<h3 class="fw-bolder m-0">Staff (Personal) Details</h3>
</div>
<!--end::Card title-->
...
<div class="col-md-2">
<input type="text" class="form-control" id="login_id" name="login_id" value="<?=!empty($query->user_login_id)?$query->user_login_id:generateUserLoginId('ST')?>" placeholder="Customer Login ID" readonly>
</div>
...
<div class="row mb-6">
<label class="col-md-2 col-form-label required fw-bold fs-6required">Email</label>
<div class="col-md-4 ">
<input type="email" name="email" class="form-control " placeholder="Email" value="<?=$query->email?>" required>
<div class="fv-plugins-message-container invalid-feedback"></div>
</div>	   
<label class="col-md-2 col-form-label  fw-bold fs-6 mb-5 text-end required ">Staff Code</label>
<div class="col-md-4">
<input type="text" name="staff_code" class="form-control " placeholder="Staff Code" value="<?=$query->staff_code?>" required>
</div>
...
<div class="row">
<div class="fv-row fv-plugins-icon-container">
<select name="state_id" id="state_id" aria-label="Select a state"  data-placeholder="Select a state.." class="form-select " onchange="getCityList(this.value)">
...
<label class="col-md-2 col-form-label  fw-bold fs-6 mb-5 text-end">City</label>
<div class="col-md-4 mb-5">
<div class="row">
<div class="fv-row fv-plugins-icon-container">
<select name="city_id" id="city_id" aria-label="Select a city"  data-placeholder="Select a city.." class="form-select " onchange="$('#state_id').val($(this).find('option:selected').data('state_id'))">
