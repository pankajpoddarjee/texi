			...
			<div id="kt_account_signin_method" class="collapse show">
				...
				<div class="card-body border-top p-9">
					...
					<div class="row mb-6" id="google_auth_code_div" style="display:<?=($profile->settings->multifactor_authenticate=='1' && ($profile->settings->authenticate_using_google=='1') )?'flex':'none';?>; ">
						...
						<!--begin::Col-->
						<div class="col-lg-8 fv-row">
							<input type="text" class="form-control form-control-lg form-control-solid " placeholder="<?=($this->session->flashdata('error_msg')!='')?$this->session->flashdata('error_msg'):'Enter Google Authenticator Code';?>" name="code" id="code" autocomplete="off">
						</div>
						<!--end::Col-->
					</div>
					<!--end::Input group-->
