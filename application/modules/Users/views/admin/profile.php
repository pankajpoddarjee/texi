			...
			<div class="card-body pt-0 pb-0">
				...
				<div class="d-flex overflow-auto h-55px">
					<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">						
						<!--begin::Nav item-->
						<li class="nav-item">
							<a class="nav-link text-active-primary me-6 active" href="<?=base_url('Users/profile')?>">Personal Information</a>
						</li>
						<!--end::Nav item-->
						<!--begin::Nav item-->
						<li class="nav-item">
		...
		<!--START::ALERT MESSAGE --><?php $this->load->view('templates/admin/alert');?><!--END::ALERT MESSAGE -->
			...
			<div id="kt_account_profile_details" class="collapse show">
					...
					<div class="card-body border-top p-9">
							...
							<div class="col-lg-8">
								...
								<div class="row">
									...
									<div class="col-lg-6 fv-row">
										<input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" type="text" value="<?=$profile->fname?>" name="fname" required placeholder="First name">
									</div>
									<!--end::Col-->
									<!--begin::Col-->
									<div class="col-lg-6 fv-row">
										<input type="text" name="lname" class="form-control form-control-lg form-control-solid" placeholder="Last name" value="<?=$profile->lname?>" required />
									</div>
									<!--end::Col-->
								</div>
								<!--end::Row-->
						...
						<div class="row mb-6">
							...
							<div class="col-lg-8 fv-row">
								<div class="input-group mb-3">
									...
									<input type="tel" name="phone_no" class="form-control form-control-lg form-control-solid" placeholder="Phone number" value="<?=$profile->phone_no?>" required />
								</div>
							</div>
							<!--end::Col-->
						</div>
						...
						<div class="row mb-6">
							<!--begin::Label-->
							<label class="col-lg-4 col-form-label fw-bold fs-6">About Yourself</label>
							<!--end::Label-->
							<!--begin::Col-->
							<div class="col-lg-8 fv-row">
								<textarea name="about" id="about" placeholder="About Yourself" class="form-control form-control-lg form-control-solid" ><?=$profile->about?></textarea>      
							</div>
							<!--end::Col-->
						</div>
						<!--end::Input group-->
