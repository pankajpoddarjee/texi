...
<div class="row">
<div class="fv-row fv-plugins-icon-container">
<select name="staff_category_id" class="form-control" required="">
<option value="">Select Job Type</option>
<?php
if(!empty($c_category)){
        foreach($c_category as $k=>$category){
?>
<option value="<?=$category->id?>" <?= ($category->id == $query->staff_category_id ) ? 'selected' : '' ?>><?=$category->category_name?></option>
<?php } }?>
</select>
<div class="fv-plugins-message-container invalid-feedback"></div>
</div>
