<!--begin::Form-->
<form class="form" id="update_form_<?=$query->id?>" method="POST" action="<?=base_url('Jobs/save/'.$query->id)?>" id="" data-kt-redirect="<?=base_url('Jobss/save/'.$query->id)?>" enctype="multipart/form-data">
<!--begin::Modal header-->
<div class="modal-header" id="kt_modal_edit_header">
<!--begin::Modal title-->
<h2 class="fw-bolder">Save Jobs</h2>
<!--end::Modal title-->
<!--begin::Close-->
...
<div class="scroll-y me-n7 pe-7" id="kt_modal_edit_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_edit_header" data-kt-scroll-wrappers="#kt_modal_edit_scroll" data-kt-scroll-offset="300px">
        ...
        <div class="fv-row mb-7">
                ...
                <input class="form-control form-control-solid" type="text" value="<?=$query->title?>" name="title" placeholder="Jobs Title" autocomplete="off" required>
        </div>
        <div class="fv-row mb-7">
                <label class="fs-6 fw-bold mb-2">Location</label>
                <input class="form-control form-control-solid" type="text" value="<?=$query->location?>" name="location" placeholder="Location" autocomplete="off" required>
        </div>
        ...
        <div class="fv-row mb-7">
            <label class="fs-6 fw-bold mb-2">What we offer</label>
            <textarea name="what_we_offer" class="form-control form-control-solid editor" rows="5" placeholder="What We Offer"><?=$query->what_we_offer?></textarea>
        </div>
