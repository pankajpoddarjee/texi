        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_listing_table">
                ...
                if(!empty($datas)){
                        foreach($datas as $k=> $rows)
                        {
                                ...
                                $edit_link = base_url('JobsApplied/save/'.$id);
                                $delete_link = base_url('JobsApplied/remove/'.$id);
                                $status_link = base_url('JobsApplied/statusChange/'.$id);
                ...
                <tr id="tr_<?=$rows->id?>">							
                        ...
                        <td>
                            <a href="<?=base_url('assets/uploads/opportunities/' . $rows->resume)?>" target="_blank;"><?= ucfirst($rows->fname)?></a>
                        </td>
                        <td><?=$rows->email?></td>
                        <td><?=$rows->job_name?></td>
                        <td><?=$rows->job_location?></td>
