      ...
      <div class="" id="container">
        ...
        <form id="multi-step-form" name="frm1" method="post" class="multi-step-form">
              ...
              <div class="tab-content">
                <div id="tab_1" class="tab-pane active">
                  ...
                  <div class="form-group">
                    <div class="d-flex align-self-center">
                      ...
                      <div class="form-check-inline">
                        <input class="btn-check pickup-check-address-type" type="radio" name="hour_pickup_address_type" id="hour_pickup_address_type11" checked value="address" >
                        <label class="btn btn-outline-primary" for="hour_pickup_address_type11">
                          Address
                        </label>
                      </div>
                      <div class="form-check-inline">
                        <input class="btn-check pickup-check-address-type" type="radio" name="hour_pickup_address_type" id="hour_pickup_address_type12" value="airport" >
                  ...
                  <div class="form-group" id="hour-flight-number_address-div" style="display:none">   
                    ...
                    <input type="text" id="hour_flight_number" name="hour_flight_number" class="form-control" placeholder="Flight Number" onfocus="document.querySelector('#error_message_hour_flight_number').style.display = 'none'">
                    <div style="color:red;display:none;" id="error_message_hour_flight_number" >Please put flight number</div>
                  </div>

                  <div class="form-group" id="hour-wait-time-div" style="display:none">  
                    <label>Wait Time</label>                  
                    <select class="form-control" id="hour_wait_time" name="hour_wait_time" onchange="document.querySelector('#error_message_hour_wait_time').style.display = 'none'">
                    ...
                    <div style="color:red;display:none;" id="error_message_hour_wait_time" >Please select wait time</div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="d-flex">
                      ...
                      <div class="form-check-inline">
                        <input class="btn-check dropup-check-address-type" type="radio" name="hour_dropup_address_type" id="hour_dropup_address_type21" checked value="address">
                        <label class="btn btn-outline-primary" for="hour_dropup_address_type21">
                          Address 
                        </label>
                      </div>
                      <div class="form-check-inline ">
                        <input class="btn-check dropup-check-address-type" type="radio" name="hour_dropup_address_type" id="hour_dropup_address_type22" value="airport">
                  ...
                  <div class="form-group" id="hour-terminal-div" style="display:none">  
                    ...
                    <select class="form-control" id="hour_terminal" name="hour_terminal" onchange="document.querySelector('#error_message_hour_terminal').style.display = 'none'">
                      <option value="" selected>Select</option>
                      <option value="t1">Quantas Domestic</option>
                      <option value="t2">International</option>
                      <option value="t3">Virgin Domestic</option>
                      <option value="t4">Jetstar, Regional express domestic</option>
                    </select>
                    <div style="color:red;display:none;" id="error_message_hour_terminal" >Please select terminal</div>
                  </div>
                ...
                <div id="tab_2" class="tab-pane fade">
                  ...
                  <div class="form-group">
                    <div class="d-flex">
                      <label class="align-self-center me-3">Pick-up</label>
                      <div class="form-check-inline">
                        <input class="btn-check pickup-check-address-type" type="radio" name="one_pickup_address_type" id="one_pickup_address_type31" checked value="address">
                        <label class="btn btn-outline-primary" for="one_pickup_address_type31">
                          Address 
                        </label>
                      </div>
                      <div class="form-check-inline ">
                        <input class="btn-check pickup-check-address-type" type="radio" name="one_pickup_address_type" id="one_pickup_address_type32" value="airport">
                  ...
                  <div class="form-group" id="one-flight-number_address-div" style="display:none">   
                    <label for="">Flight Number</label>                 
                    <input type="text" id="one_flight_number" name="one_flight_number" class="form-control" placeholder="Flight Number" onfocus="document.querySelector('#error_message_one_flight_number').style.display = 'none'">
                    <div style="color:red;display:none;" id="error_message_one_flight_number" >Please put flight number</div>
                  </div>

                  <div class="form-group" id="one-wait-time-div" style="display:none">  
                    <label>Wait Time</label>                  
                    <select class="form-control" id="one_wait_time" name="one_wait_time" onchange="document.querySelector('#error_message_one_wait_time').style.display = 'none'">
                      <option value="" selected>Select</option>
                      <option value="15">15 Minute</option>
                      <option value="30">30 Minute</option>
                      <option value="45">45 Minute</option>
                    ...
                    <div style="color:red;display:none;" id="error_message_one_wait_time" >Please select wait time</div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="d-flex">
                      <label class="align-self-center me-3">Drop-off</label>
                      <div class="form-check-inline">
                        <input class="btn-check dropup-check-address-type" type="radio" name="one_dropup_address_type" id="one_dropup_address_type41" checked value="address">
                        <label class="btn btn-outline-primary" for="one_dropup_address_type41">
                          Address 
                        </label>
                      </div>
                      <div class="form-check-inline ">
                        <input class="btn-check dropup-check-address-type" type="radio" name="one_dropup_address_type" id="one_dropup_address_type42" value="airport">
                  ...
                  <div class="form-group" id="one-terminal-div" style="display:none">  
                    <label>Terminal</label>                  
                    <select class="form-control" id="one_terminal" name="one_terminal" onchange="document.querySelector('#error_message_one_terminal').style.display = 'none'">
                      <option value="" selected>Select</option>
                      <option value="t1">Quantas Domestic</option>
                      <option value="t2">International</option>
                      <option value="t3">Virgin Domestic</option>
                    ...
                    <div style="color:red;display:none;" id="error_message_one_terminal" >Please select terminal</div>
                  </div>
                  ...
                  <div class="round-pick-up">
                    ...
                    <div class="form-group">
                      <div class="d-flex">
                        <label class="align-self-center me-3">Pick-up</label>
                        <div class="form-check-inline">
                          <input class="btn-check pickup-check-address-type" type="radio" name="return_one_pickup_address_type" id="return_one_pickup_address_type51" checked value="address">
                          <label class="btn btn-outline-primary" for="return_one_pickup_address_type51">
                            Address 
                          </label>
                        </div>
                        <div class="form-check-inline ">
                          <input class="btn-check pickup-check-address-type" type="radio" name="return_one_pickup_address_type" id="return_one_pickup_address_type52" value="airport">
                    ...
                    <div class="form-group" id="return-one-flight-number_address-div" style="display:none">   
                      <label for="">Flight Number</label>                 
                      <input type="text" id="return_one_flight_number" name="return_one_flight_number" class="form-control" placeholder="Flight Number" onfocus="document.querySelector('#error_message_return_one_flight_number').style.display = 'none'">
                      <div style="color:red;display:none;" id="error_message_return_one_flight_number" >Please put flight number</div>
                    </div>

                    <div class="form-group" id="return-one-wait-time-div" style="display:none">  
                      <label>Wait Time</label>                  
                      <select class="form-control" id="return_one_wait_time" name="return_one_wait_time" onchange="document.querySelector('#error_message_return_one_wait_time').style.display = 'none'">
                        <option value="" selected>Select</option>
                        <option value="15">15 Minute</option>
                        <option value="30">30 Minute</option>
                        <option value="45">45 Minute</option>
                      ...
                      <div style="color:red;display:none;" id="error_message_return_one_wait_time" >Please select wait time</div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="d-flex">
                        <label class="align-self-center me-3">Drop-off</label>
                        <div class="form-check-inline">
                          <input class="btn-check dropup-check-address-type" type="radio" name="return_one_dropup_address_type" id="return_one_dropup_address_type61" checked value="address">
                          <label class="btn btn-outline-primary" for="return_one_dropup_address_type61">
                            Address 
                          </label>
                        </div>
                        <div class="form-check-inline ">
                          <input class="btn-check dropup-check-address-type" type="radio" name="return_one_dropup_address_type" id="return_one_dropup_address_type62" value="airport">
                    ...
                    <div class="form-group" id="return-one-terminal-div" style="display:none">  
                      <label>Terminal</label>                  
                      <select class="form-control" id="return_one_terminal" name="return_one_terminal" onchange="document.querySelector('#error_message_return_one_terminal').style.display = 'none'">
                        <option value="" selected>Select</option>
                        <option value="t1">Quantas Domestic</option>
                        <option value="t2">International</option>
                        <option value="t3">Virgin Domestic</option>
                      ...
                      <div style="color:red;display:none;" id="error_message_return_one_terminal" >Please select terminal</div>
                    </div>
                  ...
                  <div class="round-drop-off">
                    ...
                    <div class="form-group">
                      <div class="d-flex">
                        <label class="align-self-center me-3">Pick-up</label>
                        <div class="form-check-inline">
                          <input class="btn-check pickup-check-address-type" type="radio" name="return_two_pickup_address_type" id="return_two_pickup_address_type71" checked value="address" return="1">
                          <label class="btn btn-outline-primary" for="return_two_pickup_address_type71">
                            Address 
                          </label>
                        </div>
                        <div class="form-check-inline ">
                          <input class="btn-check pickup-check-address-type" type="radio" name="return_two_pickup_address_type" id="return_two_pickup_address_type72" value="airport" return="1">
                    ...
                    <div class="form-group" id="return-two-flight-number_address-div" style="display:none">   
                      <label for="">Flight Number</label>                 
                      <input type="text" id="return_two_flight_number" name="return_two_flight_number" class="form-control" placeholder="Flight Number" onfocus="document.querySelector('#error_message_return_two_flight_number').style.display = 'none'">
                      <div style="color:red;display:none;" id="error_message_return_two_flight_number" >Please put flight number</div>
                    </div>

                    <div class="form-group" id="return-two-wait-time-div" style="display:none">  
                      <label>Wait Time</label>                  
                      <select class="form-control" id="return_two_wait_time" name="return_two_wait_time" onchange="document.querySelector('#error_message_return_two_wait_time').style.display = 'none'">
                        <option value="" selected>Select</option>
                        <option value="15">15 Minute</option>
                        <option value="30">30 Minute</option>
                        <option value="45">45 Minute</option>
                      ...
                      <div style="color:red;display:none;" id="error_message_return_two_wait_time" >Please select wait time</div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="d-flex">
                        <label class="align-self-center me-3">Drop-off</label>
                        <div class="form-check-inline">
                          <input class="btn-check dropup-check-address-type" type="radio" name="return_two_dropup_address_type" id="return_two_dropup_address_type81" checked value="address" return="1">
                          <label class="btn btn-outline-primary" for="return_two_dropup_address_type81">
                            Address 
                          </label>
                        </div>
                        <div class="form-check-inline ">
                          <input class="btn-check dropup-check-address-type" type="radio" name="return_two_dropup_address_type" id="return_two_dropup_address_type82" value="airport" return="1">
                    ...
                    <div class="form-group" id="return-two-terminal-div" style="display:none">  
                      <label>Terminal</label>                  
                      <select class="form-control" id="return_two_terminal" name="return_two_terminal" onchange="document.querySelector('#error_message_return_two_terminal').style.display = 'none'">
                        <option value="" selected>Select</option>
                        <option value="t1">Quantas Domestic</option>
                        <option value="t2">International</option>
                        <option value="t3">Virgin Domestic</option>
                      ...
                      <div style="color:red;display:none;" id="error_message_return_two_terminal" >Please select terminal</div>
                    </div>
          ...
          <div class="step step-2"> 
            ...
            <input type="text" id="return_distance" name="return_distance">
          ...
          <div class="step step-3">
            ...
            <h2 id="date-time-return-final">Mar 11th 2024, 12:31 PM</h2>
            <hr>
